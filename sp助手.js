...
(function() {
    ...
    if(href.includes("seller")){
        ...
        const data = {
            ...
            //"整页"模块是否出现的开关
            status3:()=>{
                let data = localStorage.getItem("status3");
                if(data!=null){
                    //console.log("学",data);
                    return JSON.parse(data)
                }else if(data==null){
            ...
            //"单个模块"是否出现的开关
            status4:()=>{
                let data = localStorage.getItem("status4");
                if(data!=null){
                    //console.log("学",data);
                    return JSON.parse(data)
                }else if(data==null){
            ...
            //"同店多个"模块是否出现的开关
            status5:()=>{
                let data = localStorage.getItem("status5");
                if(data!=null){
                    //console.log("学",data);
                    return JSON.parse(data)
                }else if(data==null){
            ...
            //"跨店多个"模块是否出现的开关
            status6:()=>{
                let data = localStorage.getItem("status6");
                if(data!=null){
                    //console.log("学",data);
                    return JSON.parse(data)
                }else if(data==null){
            ...
            //"线下单个"模块是否出现的开关
            status7:()=>{
                let data = localStorage.getItem("status7");
                if(data!=null){
                    //console.log("学",data);
                    return JSON.parse(data)
                }else if(data==null){
            ...
            //"关注店铺"模块是否出现的开关
            status8:()=>{
                let data = localStorage.getItem("status8");
                if(data!=null){
                    //console.log("学",data);
                    return JSON.parse(data)
                }else if(data==null){
            ...
            //"翻页功能"模块是否出现的开关
            status9:()=>{
                let data = localStorage.getItem("status9");
                if(data!=null){
                    //console.log("学",data);
                    return JSON.parse(data)
                }else if(data==null){
        ...
        const toPageData={
            aimPages:()=>{
                let data = localStorage.getItem("toPageDataAimPages");
                if(data!=null){
                    return JSON.parse(data)
                }else if(data==null){
                    return 0
            ...
            nowPage:()=>{
                let data = localStorage.getItem("nowPage");
                if(data!=null){
                    return JSON.parse(data)
                }else if(data==null){
                    return 0
        ...
        //翻页模块(页面8) #分面板 #翻页面板
        function toPage(){
            const [input1, setInput1] = CAT_UI.useState(toPageData.aimPages)
            const [value,setValue]=CAT_UI.useState(toPageData.nowPage)
            console.log("猴")
            return CAT_UI.Space(
                [
                    CAT_UI.createElement(
                        ...
                        CAT_UI.createElement(
                            ...
                            CAT_UI.Input({
                                ...
                                onChange(val) {
                                    setInput1(val);
                                    localStorage.setItem("toPageDataAimPages",val);
                                },
                                style: {
                                    flex: 1,
                                },
                            ...
                            CAT_UI.Button("开始关注", {
                                ...
                                onClick() {
                                    ...
                                    let Interval=setInterval(()=>{
                                        ...
                                        dom.click()
                                        let nowPage=document.querySelector('.shopee-button-solid.shopee-button-solid--primary').innerHTML
                                        setValue(nowPage)
        ...
        CAT_UI.createPanel({
            ...
            header: {
                title() {
                    ...
                    const [input1, setInput1] = CAT_UI.useState(data.frequency1);//采集频率
                    const [input2, setInput2] = CAT_UI.useState(data.status1);//同店多个的自动模式
                    const [input3, setInput3] = CAT_UI.useState(data.status2);//"整店"
                    const [input4, setInput4] = CAT_UI.useState(data.status3);//"整页"
                    const [input5, setInput5] = CAT_UI.useState(data.status4);//"单个"
                    const [input6, setInput6] = CAT_UI.useState(data.status5);//"同店多个"
                    const [input7, setInput7] = CAT_UI.useState(data.status6);//"跨店多个"
                    const [input8, setInput8] = CAT_UI.useState(data.status7);//"线下单个"
                    const [input9, setInput9] = CAT_UI.useState(data.status8);//"关注店铺"
                    const [input10, setInput10] = CAT_UI.useState(data.status9);//"翻页功能"
                    ...
                    return CAT_UI.el(
                        ...
                        CAT_UI.Space([
                            input3?CAT_UI.Router.Link("整店", { to: "/" }):null,
                            input4?CAT_UI.Router.Link("整页", { to: "/Page" }):null,
                            input5?CAT_UI.Router.Link("单个", { to: "/single" }):null,
                            input6?CAT_UI.Router.Link("同店多个", { to: "/many" }):null,
                            input7?CAT_UI.Router.Link("跨店多个", { to: "/other" }):null,
                            input8?CAT_UI.Router.Link("线下单个", { to: "/offLine" }):null,
                            //console.log("路",input3),
                            input9?CAT_UI.Router.Link("关注店铺", { to: "/followPage" }):null,
                            input10?CAT_UI.Router.Link("翻页功能", { to: "/toPage" }):null,
                                    ...
                                    CAT_UI.createElement(//相当于div
                                        ...
                                        CAT_UI.Checkbox("",{
                                            ...
                                            onChange(checked){
                                                ...
                                                if(checked){
                                                    setInput4(1);
                                                    localStorage.setItem("status3","1");
                                                    console.log("名")


                                                }else{
                                                    setInput4(0);
                                                    localStorage.setItem("status3","0");
                                    ...
                                    CAT_UI.createElement(//相当于div
                                        ...
                                        CAT_UI.Checkbox("",{
                                            ...
                                            onChange(checked){
                                                ...
                                                if(checked){
                                                    setInput5(1);
                                                    localStorage.setItem("status4","1");
                                                    console.log("名")


                                                }else{
                                                    setInput5(0);
                                                    localStorage.setItem("status4","0");
                                    ...
                                    CAT_UI.createElement(//相当于div
                                        ...
                                        CAT_UI.Checkbox("",{
                                            ...
                                            onChange(checked){
                                                ...
                                                if(checked){
                                                    setInput6(1)
                                                    localStorage.setItem("status5","1");
                                                    console.log("名")


                                                }else{
                                                    setInput6(0);
                                                    localStorage.setItem("status5","0");
                                    ...
                                    CAT_UI.createElement(//相当于div
                                        ...
                                        CAT_UI.Checkbox("",{
                                            ...
                                            onChange(checked){
                                                ...
                                                if(checked){
                                                    setInput7(1);
                                                    localStorage.setItem("status6","1");
                                                    console.log("名")


                                                }else{
                                                    setInput7(0);
                                                    localStorage.setItem("status6","0");
                                    ...
                                    CAT_UI.createElement(//相当于div
                                        ...
                                        CAT_UI.Checkbox("",{
                                            ...
                                            onChange(checked){
                                                ...
                                                if(checked){
                                                    setInput8(1)
                                                    localStorage.setItem("status7","1");
                                                    console.log("名")


                                                }else{
                                                    setInput8(0);
                                                    localStorage.setItem("status7","0");
                                    ...
                                    CAT_UI.createElement(//相当于div
                                        ...
                                        CAT_UI.Checkbox("",{
                                            ...
                                            onChange(checked){
                                                ...
                                                if(checked){
                                                    setInput9(1);
                                                    localStorage.setItem("status8","1");
                                                    console.log("名")


                                                }else{
                                                    setInput9(0);
                                                    localStorage.setItem("status8","0");
                                    ...
                                    CAT_UI.createElement(//相当于div
                                        ...
                                        CAT_UI.Checkbox("",{
                                            ...
                                            onChange(checked){
                                                ...
                                                if(checked){
                                                    setInput10(1);
                                                    localStorage.setItem("status9","1");
                                                    console.log("名")


                                                }else{
                                                    setInput10(0);
                                                    localStorage.setItem("status9","0");
